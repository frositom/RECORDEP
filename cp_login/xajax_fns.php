...
$xajax->configure('decodeUTF8Input',true);  // para corregir 
	...
	function Verificar_Seguridad($formaction){
		$respuesta = new xajaxResponse();		$usu= $formaction['usuario'];		$pas=$formaction['pass'];		$trae=$formaction['intentos'];		$user=$formaction['user'];						//======= VALIDCIONES ========//		if($usu== '' || $pas==''){			$respuesta->script("alert('Error del Sistema, Contacte a su Administrador !!!');");			$respuesta->script("location.reload();");			return $respuesta;		}else{						$respuesta->alert('si llega al xajax');		}				
...
///////////////////////////////////////////////////////////////////////////////////////////
	...
	$xajax->register(XAJAX_FUNCTION, "Alert_Seguridad");//El objeto xajax tiene que procesar cualquier petici??	
